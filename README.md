...
1. Open a Vue file in your Inertia.js project (e.g., `resources/js/pages/Users/Index.vue`)
2. Find an action string in your Vue template or script (e.g., `'updateUser'`)
...
4. The extension will navigate you to the Laravel controller method where:
   ...
   - The method contains `$ctx->updateUser`
...
The extension:
1. Extracts the component path from your current Vue file (e.g., `Users/Index` from `resources/js/pages/Users/Index.vue`)
2. Scans PHP files in `app/Http/Controllers`
3. Filters methods containing `return $this->responser`
4. Matches the component path pattern: `$ctx->component = fn () => 'Users/Index'`
